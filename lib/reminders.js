...
module.exports = {
  async dispatch(context) {
    ...
    let issue = {
      ...
      labels: resp.node.labels.nodes
    }
    console.log("issue", issue)
    //context.payload.client_payload.command.resource
    await processObject(reminder, context, issue, octokit)
  },
...
processObject = async function (reminder, context, issue_in, octokit) {
  let { labels } = issue_in
