...
module.exports = {
  async dispatch(context) {
    ...
    console.log("remind @me on "+reminder.when_raw+ ' foo me then');
    let parse_result = parseReminder("/remind @me"+reminder.when_raw+ ' foo me then@')
    reminder.when = parse_result.when;
    console.log('reminder',reminder);
    await this.processObject(reminder, octokit)
  },
